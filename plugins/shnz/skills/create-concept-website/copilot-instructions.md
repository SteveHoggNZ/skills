# Create Concept Website (Copilot adapter)
...
- Use VS Code's file + terminal tools for authoring HTML. Preview from the integrated terminal with `open index.html` or `python3 -m http.server 8000 --directory <target-dir>`.
- Reference material:
